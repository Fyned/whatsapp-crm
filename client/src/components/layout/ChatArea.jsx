...
import { Send, DownloadCloud, CheckCheck, Loader2, FileText, Image, Video, Zap } from 'lucide-react';
        ...
        return (
            <div className="mb-1">
                <img 
                    src={fullMediaUrl} 
                    alt="Fotoğraf" 
                    className="rounded-lg max-w-full h-auto object-cover max-h-64 cursor-pointer hover:opacity-90 border border-gray-200"
            ...
            >
                ...
                <div className="overflow-hidden min-w-0">
                    <p className="text-sm font-semibold text-gray-800 truncate">
                        {msg.body || (isAudio ? 'Ses Kaydı' : 'Belge')}
                    </p>
                    <span className="text-[10px] text-blue-500 font-medium hover:underline block mt-0.5">
                        İndirmek için tıkla
                    </span>
                </div>
            </div>
